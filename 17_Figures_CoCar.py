...
for sp in Sample:
    ...
    for Analysis in CoCar_Genes:
        ...
        os.chdir('C:\CoCar\out' + os.path.sep + run + os.path.sep + sp + os.path.sep +  Analysis + os.path.sep + 'Counts')
        ...
        for file in os.listdir(os.getcwd()):
            ...
            # Sauvegarde
            os.chdir('C:\CoCar\out' + os.path.sep + run + os.path.sep + sp + os.path.sep +  Analysis + os.path.sep + 'Figures\Matrices')
        ...
        nomfichier =  sp + '_' + run + '_Fig_CFull_' + Analysis + '.png'
        os.chdir('C:\CoCar\out' + os.path.sep + run + os.path.sep + sp + os.path.sep +  Analysis + os.path.sep + 'Figures')
