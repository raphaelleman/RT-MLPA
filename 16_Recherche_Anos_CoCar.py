...
if not os.path.exists('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy'):
    os.mkdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy')
    for gene in CoCar_Genes:
        os.mkdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy' + os.path.sep + gene)
        os.mkdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy' + os.path.sep + gene + os.path.sep + 'Counts')
        os.mkdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy' + os.path.sep + gene + os.path.sep + 'Figures')
        os.mkdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy' + os.path.sep + gene + os.path.sep + 'Figures' + os.path.sep + 'Matrices')

### Creation de la matrice globale
rep = 'C:\CoCar\out'+ os.path.sep + run
...
for i in CoCar_Genes:
    ...
    for j in Matrice_indexes:
        Mat_dir = 'C:\CoCar\out' + os.path.sep + run + os.path.sep + str(j) + os.path.sep + str(i) + os.path.sep + 'Figures\Matrices'
    
        if len(os.listdir(Mat_dir)) > 0:
            Mat_name = 'C:\CoCar\out' + os.path.sep + run + os.path.sep + str(j) + os.path.sep + str(i) + os.path.sep + 'Figures\Matrices' + os.path.sep + str(j) + '_Counts_' + str(i) + '.csv'
    ...
    os.chdir('C:\CoCar\out'+ os.path.sep + run)
    ...
    os.chdir('C:\CoCar\out'+ os.path.sep + run + os.path.sep + '#Moy' + os.path.sep + i + os.path.sep + 'Counts')
